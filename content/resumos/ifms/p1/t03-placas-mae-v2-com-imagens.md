...
data: 16-06-2026
disciplina: ifms
tema: T03-Placas-Mae-v2-com-imagens
tipo: resumo
prova: P1
status: finalizado
fonte: >-
...
_source: 03-Disciplinas/IFMS/Revisao/Resumos/T03-Placas-Mae-v2-com-imagens.md
---
...
> 📚 Complemento do Drive: `Tecnologia das Placas-Mãe.pdf`
> 🖼️ Versão 2: imagens do Google Drive + diagramas locais em `Revisao/Resumos/Imagens/`.
...
> [!info] Mapa visual da placa
> ![[ifms-t03-anatomia-placa-mae.svg]]
>
> Use o esquema para localizar **socket**, **slots RAM**, **PCIe**, **chipset**, **SATA**, **M.2**, conector **ATX 24 pinos** e painel traseiro.

---

## 2. Form Factors — Tamanhos de Placa-Mãe

> [!info] Imagens do Drive — form factor
> ![](https://drive.google.com/uc?id=1AXqYkHSgvzutz6aFw4pv7Fo7n5d5zgVp)
>
> ![](https://drive.google.com/uc?id=1sLJQCfn6-fVI_cKeRZcB8tFRv3mxulr0)
>
> As imagens ajudam a comparar **ATX**, **Micro-ATX** e **Mini-ITX** pelo tamanho físico e pela quantidade de slots.
...
> [!warning] Diferença visual crítica
> ![[ifms-t03-socket-lga-pga.svg]]
>
> Em Intel LGA, o ponto frágil costuma estar na **placa-mãe**. Em AMD PGA, o ponto frágil costuma estar no **processador**.
...
> [!danger] Fluxo visual da atualização
> ![[ifms-t03-bios-update.svg]]
>
> Só atualize com **modelo exato**, arquivo do **site oficial**, pendrive **FAT32** e energia estável.
