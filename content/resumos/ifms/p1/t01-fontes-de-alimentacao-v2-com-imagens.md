...
data: 16-06-2026
disciplina: ifms
tema: T01-Fontes-de-Alimentacao-v2-com-imagens
tipo: resumo
prova: P1
status: finalizado
fonte: >-
...
_source: >-
  03-Disciplinas/IFMS/Revisao/Resumos/T01-Fontes-de-Alimentacao-v2-com-imagens.md
---
...
> [!info] Visual rápido
> ![[ifms-t01-conectores-fonte.svg]]
>
> Este diagrama mostra os conectores que mais aparecem na montagem: **ATX 24 pinos**, **EPS CPU**, **PCIe GPU**, **SATA**, **Molex** e **fan**.
...
> [!info] Como visualizar o selo
> ![[ifms-t01-eficiencia-80-plus.svg]]
>
> A ideia central é simples: **mais eficiência = menos energia desperdiçada como calor**.
...
> [!tip] Imagem de apoio
> Volte ao diagrama `ifms-t01-conectores-fonte.svg` para comparar visualmente o conector ATX com EPS, PCIe, SATA e Molex antes de montar.
...
> [!warning] Esquema do teste
> ![[ifms-t01-teste-multimetro.svg]]
>
> O fio **verde** liga a fonte quando encostado no **preto**. Para medir tensão, a ponta preta do multímetro fica no GND e a vermelha vai no fio colorido testado.
